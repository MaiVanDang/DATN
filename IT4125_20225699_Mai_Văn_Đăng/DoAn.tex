...
\usepackage{
    subfiles
} % Chèn các file nhỏ, giúp chia các chapter ra nhiều file hơn
...
\usepackage[style=ieee, backend=biber, maxbibnames=10]{biblatex}
...
\usepackage[all]{
    hypcap
} % Cho phép tham chiếu chính xác đến hình ảnh và bảng biểu
...
\begin{document}
    ...
    \titlecontents{section} [0.0cm] % left margin
    {\vspace{0.3cm}} % above code
    {\thecontentslabel \ } % numbered format
    {} % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage} % filler-page-format, e.g dots

    \titlecontents{subsection} [1.0cm] % left margin
    {\vspace{0.3cm}} % above code
    {\thecontentslabel \ } % numbered format
    {} % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage} % filler-page-format, e.g dots
    ...
    \subfile{IT4125_20225699_Mai_Văn_Đăng/Chuong/3_Phan_tich_va_thiet_ke_he_thong}
    ...
    \titlecontents{chapter} [0.0cm] % left margin
    {\bfseries\vspace{0.3cm}} % above code
    {{\bfseries{\scshape} PHỤ LỤC \thecontentslabel.\ }} % numbered format
    {} % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}

    % \chapter{PHÂN TÍCH ẢNH HƯỞNG CỦA CÁC THAM SỐ}
