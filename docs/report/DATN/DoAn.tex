...
% \include{lstlisting} % (đã bỏ: không dùng chèn code)
...
\graphicspath{{Hinh_ve/}{../Hinh_ve/}{figures/}{../figures/}} % Thư mục chứa các hình ảnh
...
\subfile{Chuong/4_Xay_dung_mo_hinh}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐÁNH GIÁ THỰC NGHIỆM}
\subfile{Chuong/5_Danh_gia_thuc_nghiem}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TRIỂN KHAI TRÊN ANDROID}
\subfile{Chuong/6_Trien_khai_tren_Android}
