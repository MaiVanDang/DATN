...
Thiết bị Android hiện đại tích hợp ba cảm biến quán tính chính phục vụ bài toán nhận diện hành vi. Gia tốc kế (\textit{accelerometer}) đo gia tốc tuyến tính theo ba trục tọa độ $(x, y, z)$ với đơn vị $m/s^2$, phản ánh chuyển động tịnh tiến và rung lắc của thiết bị. Con quay hồi chuyển 
...
Random Forest là thuật toán học máy tập hợp hoạt động bằng cách xây dựng nhiều cây quyết định trong quá trình huấn luyện. Thuật toán này phù hợp để phân loại các vector đặc trưng có số chiều vừa phải như động học chạm (\textit{touch dynamics}) nhờ khả năng chống quá khớp tốt và không yêu cầu chuẩn hóa đặc trưng đầu vào. Việc mô tả mỗi thao tác vuốt hay chạm bằng một vector đặc trưng động học rồi phân loại theo từng cá nhân là cách tiếp cận đã được chứng minh hiệu quả cho sinh trắc học chạm liên tục~\cite{frank2013touchalytics}. Random Forest được lựa chọn cho nhánh touch thay vì mạng học sâu vì tập dữ liệu touch có kích thước nhỏ hơn đáng kể so với dữ liệu IMU, và một mô hình đơn giản giúp hạn chế quá khớp trên lượng dữ liệu hạn chế đó.

\subsection{Học biểu diễn phân biệt và chuẩn hóa điểm}

Chất lượng của không gian embedding quyết định trực tiếp khả năng phân biệt người lạ khi quyết định dựa trên độ tương đồng. Hàm mất mát entropy chéo thông thường chỉ yêu cầu phân loại đúng các danh tính trong tập huấn luyện, không ràng buộc khoảng cách giữa các lớp, nên embedding học được có thể chưa đủ tách bạch cho danh tính chưa gặp. Các hàm mất mát dựa trên biên góc, tiêu biểu là ArcFace~\cite{deng2019arcface}, bổ sung một biên góc giữa các lớp trên mặt cầu đơn vị nhằm tăng độ nén trong lớp và độ tách giữa các lớp; do quyết định của hệ thống dựa trên độ tương đồng cosine, hướng tiếp cận này phù hợp về mặt hình học để cải thiện khả năng tổng quát hóa, và được xem là một hướng nâng cấp bộ mã hóa trong tương lai.

Bên cạnh việc cải thiện biểu diễn, điểm tin cậy đầu ra cũng có thể được hiệu chỉnh để tách bạch tốt hơn. Một kỹ thuật kinh điển trong xác thực người nói là chuẩn hóa điểm theo một nhóm người dùng nền: điểm thô của một mẫu được chuẩn hóa theo phân bố điểm mà nhóm nền tạo ra, nhằm loại bỏ độ lệch riêng của từng hồ sơ và đưa điểm của các chủ sở hữu khác nhau về cùng một thang~\cite{auckenthaler2000score}. Kỹ thuật này không yêu cầu huấn luyện lại mô hình và được khảo sát ở Chương 5 như một hàm quyết định ứng viên.
